...
export const SkeletonCardTitle = tw.h1`w-3/4 h-3 rounded-full bg-neutral animate-pulse`;
export const SkeletonTextCard = tw.h1`w-1/2 h-2 rounded-full bg-neutral animate-pulse`;
