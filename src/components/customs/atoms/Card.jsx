...
export const SkeletonCardTitle = tw.h1`w-20 h-4 rounded-full bg-neutral animate-pulse`
export const SkeletonTextCard = tw.h1`w-24 h-2 rounded-full bg-neutral animate-pulse`
