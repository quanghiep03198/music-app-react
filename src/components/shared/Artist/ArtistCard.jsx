...
const CardWrapper = tw.div`gradient-border rounded-box relative flex max-h-[500px] max-w-xs flex-col items-stretch justify-between gap-3 overflow-hidden bg-base-200 p-5 shadow-lg duration-300 hover:cursor-grab hover:bg-base-300`;
...
const ArtistCard = ({ artistData }) => {
	return (
		<CardWrapper>
			...
			<CardImageWrapper>
				<ToggleFollowButton>
					<Swap swapOff={<BsPersonPlusFill className="text-success" />} swapOn={<BsPersonPlusFill />} />
				</ToggleFollowButton>
