      ...
      <div ref={trackCardRef}>
         {isScrollToView ? (
            <Track ref={trackCardRef}>
               ...
               <div role="cell">{track.album?.title ?? ""}</div>
               <div role="cell" className="flex items-center gap-2">
                  <BsClock /> {timer(track?.duration)}
               </div>
               <div role="cell" className="relative">
                  <Dropdown gap={6} horizontal="left" className="whitespace-nowrap">
                     <Dropdown.Toggle color="ghost" size="sm" shape="square" button={false}>
                        <Button shape="square" size="sm" color="ghost" className="hover:bg-neutral">
                           <BsThreeDots />
                        </Button>
                     </Dropdown.Toggle>
                     <Dropdown.Menu className="rounded-lg bg-base-100 p-0">
                        <Dropdown.Item>
                        ...
                        <Dropdown.Item onClick={() => setTrackToEditPlaylist(track)}>
